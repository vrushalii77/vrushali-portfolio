        ...
        <div className="btn-content">
          <Link to="/Contact">
            <button className="hireme-btn">
              <FaPaperPlane className="hireme-icon" />
              Get In Touch
            </button>
          </Link>
          <Link to="/Project">
            <button className="hireme-btn">
              <FaLaptopCode className="hireme-icon" />
              View Projects
            </button>
          </Link>
        </div>
          ...
          <div className="abt-me">
            ...
            <div className="about-body">
              ...
              <div className="abt-btn">
                <Link to="/aboutme">
                  <button className="abt-btn1">
                    <FaUser className="hireme-icon" />
                    More About Me
                  </button>
                </Link>
                <Link to="/project">
                  <button className="abt-btn1">
                    <FaBriefcase className="hireme-icon" />
                    See my work
                  </button>
                </Link>
              </div>
